...
- Built with [VitePress](https://vitepress.dev/) and the Dracula color theme
...
1. **Report an error** — Open an [issue on GitHub](https://github.com/bachdx2812/dev-learning-hub/issues) with the chapter name and a clear description.
